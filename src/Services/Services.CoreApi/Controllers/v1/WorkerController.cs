...
namespace devdeer.AssetsManager.Services.CoreApi.Controllers.v1
{
    ...
    public class WorkerController : SimpleBaseCrudController<WorkerModel, IWorkerLogic>
    {
        #region constructors and destructors

        /// <inheritdoc />
        public WorkerController(IServiceProvider serviceProvider) : base(serviceProvider)
        {
        }
        ...
        [HttpPost("Paged")]
        public async ValueTask<ActionResult<PagedResponse<WorkerModel>>> GetPagedAsync(PagedRequest request)
        {
