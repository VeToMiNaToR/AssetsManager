...
namespace devdeer.AssetsManager.Services.CoreApi.Controllers.v1
{
    ...
    public class WorkplaceController : SimpleBaseCrudController<WorkplaceModel, IWorkplaceLogic>
    {
        #region constructors and destructors

        /// <inheritdoc />
        public WorkplaceController(IServiceProvider serviceProvider) : base(serviceProvider)
        {
        }
        ...
        [HttpPost("Paged")]
        public async ValueTask<ActionResult<PagedResponse<WorkplaceModel>>> GetPagedAsync(PagedRequest request)
        {
